...
# p5-Loading-Icons
p5.js script that showcases different cyclical loading animations. Loading Icons are kept simple by the use of only black and white and primitive shapes, and manipulating them to create interesting loading animations.

[Click Here](https://septianrazi.github.io/Loading-Icons/) to see.
...
1. Clone the repo
   ```sh
   git clone https://github.com/septianrazi/Loading-Icons.git
   ```
...
Project Link: [https://github.com/septianrazi/Loading-Icons](https://github.com/septianrazi/Loading-Icons)
